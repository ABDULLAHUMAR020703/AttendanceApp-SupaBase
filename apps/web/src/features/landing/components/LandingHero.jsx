...
export function LandingHero({ onSignInClick }) {
  ...
  return (
    <section
      id="top"
      className="landing-hero relative min-h-[100svh] overflow-hidden bg-[#F8FCFD] px-4 pb-20 pt-28 sm:px-6 sm:pb-28 sm:pt-32 lg:px-8"
    >
      <HeroMeshBackground />
      ...
      <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <HeroIntro delay={0.12}>
          <h1 className="landing-display text-[2.5rem] font-bold leading-[1.05] tracking-[-0.035em] text-[#0F172A] sm:text-[3.25rem] lg:text-[3.75rem]">
            ...
            <br />
            <span className="text-[#00BFFF]">Wellbeing</span> done better.
          </h1>
        </HeroIntro>

        <HeroIntro delay={0.22}>
          <p className="landing-text mx-auto mt-6 max-w-[34rem] text-[1.05rem] font-normal leading-[1.65] text-[#64748B] sm:text-[1.125rem]">
        ...
        <HeroIntro delay={0.32} className="mt-9 w-full">
          <form
            ...
            className={[
              ...
              focused
                ? 'border border-[#00BFFF]/70 shadow-[0_0_0_4px_rgba(0,191,255,0.18),0_16px_48px_rgba(0,136,199,0.1)]'
                : 'border border-white/70 shadow-[0_14px_44px_rgba(0,136,199,0.08),inset_0_1px_0_rgba(255,255,255,0.85)]',
            ].join(' ')}
          >
