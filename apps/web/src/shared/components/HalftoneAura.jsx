...
export function HalftoneAura({ dark = false }) {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        ...
        <div
          ...
          style={{
            background: `
              ...
              radial-gradient(ellipse 60% 50% at 82% 72%, rgba(0, 191, 255, 0.14), transparent 50%),
      ...
      <div className={`absolute inset-0 ${dark ? 'bg-[radial-gradient(circle_at_18%_16%,rgba(0,191,255,0.20),transparent_32%),radial-gradient(circle_at_86%_78%,rgba(0,191,255,0.16),transparent_34%)]' : 'bg-[radial-gradient(circle_at_18%_14%,rgba(0,191,255,0.18),transparent_32%),radial-gradient(circle_at_82%_78%,rgba(112,201,239,0.16),transparent_36%)]'}`} />
      <motion.div className="absolute -left-[18%] -top-[30%] h-[76%] w-[86%] rotate-[-9deg] opacity-55 bg-[radial-gradient(circle,rgba(0,191,255,0.35)_2px,transparent_2.5px)] bg-[size:15px_15px] [mask-image:linear-gradient(135deg,#000_0%,#000_38%,transparent_76%)]" animate={{ x: [0, 12, 0], y: [0, -8, 0] }} transition={{ duration: 18, repeat: Infinity, ease: 'easeInOut' }} />
